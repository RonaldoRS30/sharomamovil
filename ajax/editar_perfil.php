<?php
	...
	if (empty($_POST['nombre_empresa'])) {
		...
		if (isset($_POST["igv_total"]) && $_POST["igv_total"]==1) 
		{
			$igv_total=1;
		}
		else
		...
		$sql="UPDATE perfil SET nombre_empresa='".$nombre_empresa."',ruc_empresa='".$ruc_empresa."' ,telefono='".$telefono."', email='".$email."', impuesto='".$impuesto."', moneda='".$moneda."', direccion='".$direccion."', ciudad='".$ciudad."', estado='".$estado."', igv_total='".$igv_total."', codigo_postal='$codigo_postal' WHERE id_perfil='1'";
