    ...
    require_once("../libraries/password_compatibility_library.php");
		...
		if (empty($_POST['firstname'])){
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
                ...
                $id_vendedor = mysqli_real_escape_string($con,(strip_tags($_POST["id_vendedor"],ENT_QUOTES)));
                ...
                if ($query_check_user == 1) {
                    ...
                    $sql = "INSERT INTO users (firstname, lastname, user_name, user_password_hash, user_email, date_added, DIREP_Codigo)
                            VALUES('".$firstname."','".$lastname."','" . $user_name . "', '" . $user_password_hash . "', '" . $user_email . "','".$date_added."','$id_vendedor');";
