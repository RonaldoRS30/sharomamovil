<?php
	...
	---------------------------*/
	/* Connect To Database*/
	require_once ("../config/dbd.php");//Contiene las variables de configuracion para conectar a la base de datos
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="btn-group" role="group" aria-label="Acciones">
                            <a href="#" class="btn btn-warning btn-sm" title="Editar usuario" onclick="obtener_datos('<?php echo $user_id; ?>');" data-toggle="modal" data-target="#myModal2">
                                <i class="glyphicon glyphicon-edit"></i> 
                            </a>
                            <!--<a href="#" class="btn btn-info btn-sm" title="Cambiar contraseña" onclick="get_user_id('<?php echo $user_id; ?>');" data-toggle="modal" data-target="#myModal3">
                                <i class="glyphicon glyphicon-cog"></i>
                            </a>
                            <a href="#" class="btn btn-danger btn-sm" title="Borrar usuario" onclick="eliminar('<?php echo $user_id; ?>')">
