    ...
    if($tipodoc == 1){
        ...
        if($queryPersona){
            ...
            if($queryCliente){
                ...
                $updateCliente = mysqli_query($con, "UPDATE cji_cliente SET CLIC_CodigoUsuario = '$codiCli' WHERE CLIP_Codigo = $idCliente");
                $queryClienteCompania = mysqli_query($con, "INSERT INTO cji_clientecompania (CLIP_Codigo, COMPP_Codigo) VALUES('$idCliente','1')");
            }else{
