<?php
	...
	$title="Configuración | Order Tracking";
              ...
              <div class="row">
                ...
                <div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-condensed">
                    <tbody>
					<tr>
                        <td class='col-md-3'>Ruc de la empresa:</td>
                        <td><input type="text" class="form-control input-sm" name="ruc_empresa" value="<?php echo $row['ruc_empresa']?>" required></td>
                      </tr>
                      <tr>
					  ...
					  <tr>
                        <td>
												<?php  
												$igv=""; 
												if ($row['igv_total']==1){$igv="checked";}
												?>
                        	<input type="checkbox" name="igv_total" id="igv_total" <?php echo $igv; ?> value="1">&nbsp;&nbsp; IGV (%):
                        </td>
